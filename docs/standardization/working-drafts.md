...
| C++26 | [N5032 (PDF) :material-open-in-new:](http://wg21.link/n5032){:target="_blank"} / [HTML :material-open-in-new:](http://eel.is/c++draft/){:target="_blank"}<br>※最終版ではない | （未発行）                                                    | ?    | 2026-?? |
